// Admin Reports View - Dynamic data loading and filtering
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (window.reportDataManager) {
        ...
        console.log('Admin Reports: Clearing existing data and creating fresh test reports...');
        ...
        console.log('Admin Reports: Created test reports:', testReports.map(r => ({ id: r.id, type: r.incidentType, status: r.status })));
    ...
    function createReportCard(report) {
        ...
        card.innerHTML = `
            ...
            <div class="card-actions">
                <a class="btn view-btn" href="adminReportDetails.html?id=${report.id}">View Report</a>
            </div>
        `;
